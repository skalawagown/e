...
public class supplier extends javax.swing.JPanel {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       String search = c_search.getText();
        try {
            ...
            ResultSet rs = s.executeQuery(" SELECT * FROM supplier WHERE kageno = '"+search+"'");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            java.sql.Statement s = db.mycon().createStatement();
            s.executeUpdate(" UPDATE supplier SET supplier_Name ='"+name+"' ,Tp_Number ='"+tp+"' WHERE kageno = '"+id+"' ");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            java.sql.Statement s = db.mycon().createStatement();
            s.executeUpdate("DELETE FROM supplier WHERE kageno = '"+id+"' ");
